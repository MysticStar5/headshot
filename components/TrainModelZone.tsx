          ...
          {!played ?
            <div className="flex flex-col gap-[12px] mb-[40px]">
              ...
              <div className="gap-[16px] text-center">
                <Button type="submit" className="w-[252px] h-[50px] rounded-[6px] py-[8px] px-[16px] gap-[8px] bg-[#FEFEFE] hover:bg-[#343839] text-[18px] text-[#141718]" isLoading={isLoading} onClick={() => setPlayed(true)}>
            ...
            <div className="flex flex-col gap-[12px] mb-[40px]">
              <div className="h-[22px] gap-[16px]"></div>
              <div className="gap-[16px] text-center">
                <Button type="submit" className="w-[312px] h-[48px] rounded-[12px] p-[12px] gap-[8px]" onClick={() => setPlayed(false)}>
