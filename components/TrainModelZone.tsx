        ...
        >
          ...
          <div className="flex flex-col gap-4 p-[20px] rounded-md bg-[#232627]">
            <div className="flex flex-row gap-[12px]">
              ...
              <Combobox title={"Shot"} options={[{ key: "Close-Up", value: "closeup" }, { key: "Standard Headshot", value: "standard" }, { key: "Bust Shot", value: "bust" }, { key: "Three-Quarter Shot", value: "threequarter" }, { key: "Environmental Portrait", value: "environmental" }]} />
              <Combobox title={"Background"} options={[{ key: "Solid color", value: "solid" }, { key: "Office environment", value: "office" }, { key: "Outdoor", value: "outdoor" }, { key: "Abstract", value: "abstract" }]} />
              <Combobox title={"Light"} options={[{ key: "Natural", value: "natural" }, { key: "Studio", value: "studio" }, { key: "High Key(bright)", value: "bright" }, { key: "Low Key(shadowed)", value: "shadowed" }]} />
            </div>

            <div className="flex flex-row gap-[12px]">
              <Combobox title={"Clothing"} options={[{ key: "Business Formal", value: "formal" }, { key: "Business Casual", value: "casual" }, { key: "Creative", value: "creative" }]} />
              <Combobox title={"Expression"} options={[{ key: "Smiling", value: "smiling" }, { key: "Serious", value: "serious" }, { key: "Pensive", value: "pensive" }, { key: "Friendly", value: "friendly" }, { key: "Approachable", value: "approachable" }]} />
              <Combobox title={"Color Palette"} options={[{ key: "Warm", value: "warm" }, { key: "Cool", value: "cool" }, { key: "Netural", value: "netural" }]} />
            </div>
